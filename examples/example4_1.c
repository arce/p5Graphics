...
bool happy = false;  // Declare a boolean named happy, assigned the value false
float x = 4.0;          // Declare a float named x, assigned the value 4.0
float y;          		// Declare a float named y (no assignment)
y = x + 5.2f;            // Assign the value of x plus 5.2 to the previously declared y
float z;                // Declare a variable named z
z = x * y + 15.0f;       // Assign it the value which 
